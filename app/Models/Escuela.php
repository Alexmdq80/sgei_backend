 ...
 * @property-read Ambito|null $ambito
 * @property-read Dependencia|null $dependencia
 ...
 * @property-read Collection<int, Inscripcion> $inscripcionProcedencias
 ...
 * @property-read Collection<int, Oferta> $ofertas
