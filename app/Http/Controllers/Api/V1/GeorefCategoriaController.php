...
use App\Http\Requests\Api\V1\GeorefCategoriaRequest;
...
class GeorefCategoriaController extends Controller
{
     ...
     */
    public function store(GeorefCategoriaRequest $request): JsonResponse
    {
     ...
     */
    public function update(GeorefCategoriaRequest $request, GeorefCategoria $georefCategoria): JsonResponse
    {
        $updated = $this->service->update($georefCategoria, $request->validated());
